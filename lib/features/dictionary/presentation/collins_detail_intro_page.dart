...
class CollinsDetailIntroPage extends StatelessWidget {
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: d != null ? _buildRichContent(skin, d) : _buildFallbackContent(skin, context),
              ),
            ),
          ],
        ),
      ...
      children: [
        ...
        Row(
          children: [
            ...
            if (d.tags.isNotEmpty) ...[SizedBox(width: 12), ...d.tags.map((tag) => _buildTag(tag, skin))],
          ],
        ),
        SizedBox(height: 16),
        ...
        // 4. See also 链接
        if (d.seeAlso.isNotEmpty) ...[_buildSeeAlsoSection(skin, d.seeAlso), SizedBox(height: 20)],
  ...
  /// 兼容旧接口的回退内容
  Widget _buildFallbackContent(SkinSystem skin, BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(color: MistralColors.cream, borderRadius: BorderRadius.circular(context.design.radius.sm)),
