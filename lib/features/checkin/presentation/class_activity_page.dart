...
class _FunctionCards extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.count(
      ...
      mainAxisSpacing: context.design.spacing.sm,
      crossAxisSpacing: context.design.spacing.sm,
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                padding: EdgeInsets.symmetric(horizontal: context.design.spacing.sm, vertical: 4),
                decoration: BoxDecoration(
