...
class StarbucksTypography {
  ...
  static TextStyle get heroWord => TextStyle(
    ...
    height: 1.20, color: StarbucksCreamColors.greenHouse,
  ...
  static TextStyle get heading1 => TextStyle(
    ...
    height: 1.15, color: StarbucksCreamColors.greenHouse,
    letterSpacing: -0.52,
  );
  ...
  static TextStyle get heading3 => TextStyle(
    ...
    height: 1.25, color: StarbucksCreamColors.greenHouse,
  );

  static TextStyle get heading4 => TextStyle(
    fontFamily: 'Inter', fontFamilyFallback: _fallback,
    fontSize: 22, fontWeight: FontWeight.w500,
    height: 1.30, color: StarbucksCreamColors.greenHouse,
  );

  static TextStyle get heading5 => TextStyle(
    fontFamily: 'Inter', fontFamilyFallback: _fallback,
    fontSize: 18, fontWeight: FontWeight.w500,
    height: 1.40, color: StarbucksCreamColors.greenHouse,
  );
